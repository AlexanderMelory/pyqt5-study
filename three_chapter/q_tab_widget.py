...
class DlgMain(QDialog):
    ...
    def __init__(self):
        ...
        self.tab_main.tabCloseRequested.connect(self.tab_close_handler)
        self.tab_main.setTabPosition(QTabWidget.West)
    ...
    def tab_close_handler(self, idx):
        answer = QMessageBox.question(
            self, 'Close Tab', f'Close Tab "{self.tab_main.tabText(idx)}"?', buttons=QMessageBox.Yes | QMessageBox.No
        )
